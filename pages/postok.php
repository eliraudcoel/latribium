...
switch($action)
{
    ...
    else //Si jamais le message n'est pas vide
    {
        ...
        //Et un petit message
        echo'<p>Votre message a bien été ajouté!<br /><br />Cliquez <a href="/PPEweb/public/index.php?page=indexForum.php">ici</a> pour revenir à l index du forum<br />
    ...
    else //Sinon, si le message n'est pas vide
    {
        ...
        Cliquez <a href="/PPEweb/public/index.php?page=indexForum.php">ici</a> pour revenir à l index du forum<br />
