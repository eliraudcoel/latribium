	...
	<form method="post" action="include/recupDonneeInscription.php" enctype="multipart/form-data"><br/>
			...
			<div id="instrument">
				<?php
					...
					echo('</select>');
				?>
				<input type="number" name="nombreAnnee" min="1" max="100" required/>
			</div>
			<h4>Profil sur le forum :</h4>
			</br>
			<h4>Choisissez votre avatar :</h4><input type="file" name="imageAvatar" id="imageAvatar" />(Taille max : 10Ko)<br />
