...
echo'<i>Vous êtes ici : </i><a href ="/PPEweb/public/index.php?page=indexForum.php">Index du forum</a>';
?>
<script>
...
while($data = $query->fetch())
{
    ...
    <a href="/PPEweb/public/index.php?page=voirforum.php&f='.$data['forum_id'].'">
    ...
    if (!empty($data['forum_post']))
    {
     ...
     $page = ceil($nbr_post / $nombreDeMessagesParPage);
         ...
         <a href="/PPEweb/public/index.php?page=voirprofil.php&m='.stripslashes(htmlspecialchars($data['idUtil'])).'&amp;action=consulter">'.$data['pseudo'].'  </a>
         <a href="/PPEweb/public/index.php?page=voirtopic.php&t='.$data['topic_id'].'&amp;pg='.$page.'#p_'.$data['post_id'].'">
